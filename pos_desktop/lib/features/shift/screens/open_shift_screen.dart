            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.lock_open_outlined, color: AppTheme.success, size: 24),
                    ),
                    const SizedBox(width: 12),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text('Smenani ochish', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF1F2937))),
                        Text('${authState.user?['name'] ?? ''}', style: const TextStyle(fontSize: 12, color: Color(0xFF6B7280))),
                      ],
                    ),
                  ],
                ),
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      const Icon(Icons.point_of_sale, color: Color(0xFF0284C7), size: 20),
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(session?.organizationName ?? '—',
                                style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: Color(0xFF0C4A6E))),
                            Text('${session?.branchName ?? ''} • ${session?.terminalName ?? ''}',
                ...
                // Opening cash
                const Text("Kassada mavjud naqd pul (boshlang'ich saldo)",
                ...
                Container(
                  ...
                  child: const Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Kassadagi naqd pulni sanab, to\'g\'ri miqdorni kiriting. Bu smena hisobotida ko\'rsatiladi.',
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    label: Text(_isLoading ? 'Ochilmoqda...' : 'Smenani ochish',
